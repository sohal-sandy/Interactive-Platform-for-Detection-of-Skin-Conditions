...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            return self.ingestion_config.train_dir, self.ingestion_config.test_dir
...
if __name__ == "__main__":
    ...
    try:
        ...
        train_transformed, test_transformed, _ = data_transformation.initiate_data_transformation(train_data_dir, test_data_dir)

        # Step 3: Model Training
        #model_trainer = ModelTrainer()
        #result = model_trainer.initiate_model_trainer(train_transformed, test_transformed)
